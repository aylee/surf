...
It is neither an observation nor breaking-wave face-height truth. Ocean Beach
and Stinson use that modeled Hs directly. Linda Mar uses SM371, a 15.01 m point
outside the cove, followed by the visible cold-start `0.60` final cove scale.
...
source URL, and source-file update time in downstream forecast provenance.
